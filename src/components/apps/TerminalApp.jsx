...
const COMMANDS = {
  ...
  whoami: function () {
    return [
      ...
      { type: 'text', text: 'Role      → Associate System Engineer @ IBM India' },
      { type: 'text', text: 'Domain    → Oracle Cloud Middleware' },
      { type: 'text', text: 'Location  → Bangalore, India' },
  ...
  'cat resume.txt': function () {
    return [
      ...
      { type: 'text', text: '  → IBM India    Associate System Engineer (Apr 2026–Present)' },
      { type: 'text', text: '                 Oracle Cloud Middleware · SOA · WebLogic · OIC' },

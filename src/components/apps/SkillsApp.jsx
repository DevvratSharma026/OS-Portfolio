...
const TABS = [
  ...
  },
  {
    ...
    skills: [
      { name: 'Oracle SOA Suite', level: 65, note: 'IBM — Middleware domain' },
      { name: 'WebLogic Server', level: 62, note: 'Oracle Cloud Middleware' },
      { name: 'Oracle Integration Cloud', level: 60, note: 'OIC · IBM India' },
    ]
  }
]
